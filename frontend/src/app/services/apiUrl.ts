export class ApiUrl {
    public static LOGINADMIN = 'users/login'
    public static  REGISTERADMIN='users/register'
    ...
    public static RATINGGET = 'ratings/get'
    public static AVGRATING= 'ratings/avg'
    public static RATING = 'productitems/'
